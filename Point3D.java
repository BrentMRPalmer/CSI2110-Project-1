 ...
 * any, it is part of. 
 * 
 * The class includes getters for each of the four instance variables. It also includes a method
 * to calculate the distance between the point that invokes the method, and any other point. 
 *
 * @author Brent Palmer
 */
