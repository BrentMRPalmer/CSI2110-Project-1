 ...
 * 
 * The class has five instance variables. points is used to store the list of all the points.
 ...
 * and clusters is an ArrayList of cluster objects to store info unique to each cluster.
 * 
 * The class has setters for eps and minPts. It has getters for eps, minPts, clusters, 
 ...
 * a file, eps, and minPts, and output the results to a csv file using save. 
 * 
...
public class DBScan {
    ...
    public void findClusters() {
        ...
        //create NearestNeighbors instance to find neighbors
        NearestNeighbors neighborFinder = new NearestNeighbors(points);
        ...
        for (Point3D point : points){
            ...
            neighbors = neighborFinder.rangeQuery(eps, point);
            ...
            while( !toProcess.empty() ){
                ...
                neighbors = neighborFinder.rangeQuery(eps, current);
    ...
    /**
     * The static method <b>save</b> is used to write the list of Point3D objects
     ...
     * that stores the points, the desired eps and minPts, and then 
    ...
    public static void main(String[] args){
        ...
        try{
            ...
            scan.save(args[0].substring(0, args[0].length()-4) + "_clusters_" + scan.getEps() + "_" + scan.getMinPts() + "_" + scan.getNumberOfClusters() + ".csv");
